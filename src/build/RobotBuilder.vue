...
<div>
    ...
    <div class="middle-row">
      <div class="left part">
        <img :src="availableParts.arms[selectLeftArmIndex].src" title="lef arm"/>
...
export default {
  ...
  methods: {
    ...
    selectPreviousLeftArm() {
      this.selectLeftArmIndex =
      getPrevuiousValidIndex(this.selectLeftArmIndex, availableParts.arms.length);
    },
    selectNextRightArm() {
    ...
    selectPreviousRightArm() {
      this.selectRightArmIndex =
      getPrevuiousValidIndex(this.selectRightArmIndex, availableParts.arms.length);
    },
    selectNextTorso() {
